...
import fetchLengthOfSpots from '@salesforce/schema/Job__c.Length_of_Spots__c';
...
export default class CreateNewTVJob extends NavigationMixin(LightningElement) {
    ...
    selectedIncentiveTV = false;
    selectedTVShootProduction = false;
    selectedTVShootConcept = false;
    selectedTacticalTV = false;
    selectedTagging = false;
    ...
    @wire(getPicklistValues,{
        recordTypeId: '012800000003Wk5AAE',
    ...
    @wire(getPicklistValues, {recordTypeId: '012000000000000AAA', fieldApiName: fetchLengthOfSpots })
    ...
    handleChange(event) {
        ...
        else if (field === 'IncentiveTV') {
            this.selectedIncentiveTV = event.target.checked;
        }
        else if (field === 'TVShootProduction') {
            this.selectedTVShootProduction = event.target.checked;
        }
        else if (field === 'TVShootConcept') {
            this.selectedTVShootConcept = event.target.checked;
        }
        else if (field === 'TacticalTV') {
            this.selectedTacticalTV = event.target.checked;
        }
        else if (field === 'Tagging') {
            this.selectedTagging = event.target.checked;
        }
...
*/
    ...
    createJobRecord() {
        ...
        jobRecord.Incentive_TV__c = this.selectedIncentiveTV;
        jobRecord.TV_Shoot_Production__c = this.selectedTVShootProduction;
        jobRecord.TV_Shoot_Concept__c = this.selectedTVShootConcept;
        jobRecord.Tactical_TV__c = this.selectedTacticalTV;
        jobRecord.Tagging__c = this.selectedTagging;
