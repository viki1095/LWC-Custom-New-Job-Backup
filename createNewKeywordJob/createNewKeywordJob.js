...
import saveNewKeywordJob from '@salesforce/apex/CreateJobWizardController.saveJob';


export default class CreateNewKeywordJob extends NavigationMixin(LightningElement) {
...
*/
        ...
        if(allValid1  && all_Compobox_Valid){
            ...
            saveNewKeywordJob({ newJob: jobRecordInfo }).then(accountId => {
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Success',
    ...
    createJobRecord() {
        ...
        jobRecord.Type__c = 'Keyword Campaign';
