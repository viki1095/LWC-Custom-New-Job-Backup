...
export default class CreateNewRadioJob extends NavigationMixin(LightningElement) {
    ...
    selectedNewRadioAd = false;
    selectedIncentiveRadio = false;
    ...
    @wire(getPicklistValues,{
        recordTypeId: '012800000003WkBAAU',
    ...
    */
    ...
    handleChange(event) {
        ...
        else if (field === 'NewRadioAd') {
            this.selectedNewRadioAd = event.target.checked;
        }
        else if (field === 'IncentiveRadio') {
            this.selectedIncentiveRadio = event.target.checked;
        }
    ...
    createJobRecord() {
        ...
        jobRecord.New_Radio_Ad__c = this.selectedNewRadioAd;
        jobRecord.Incentive_Radio__c = this.selectedIncentiveRadio;
