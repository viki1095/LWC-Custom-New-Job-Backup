...
//import pickListValueDynamically from '@salesforce/apex/CreateJobWizardController.pickListValueDynamically';
import { getPicklistValues } from 'lightning/uiObjectInfoApi';
import EmailTemplate_FIELD from '@salesforce/schema/Job__c.Email_Template__c';

import saveNewEmailJob from '@salesforce/apex/CreateJobWizardController.saveJob';

export default class CreateNewEmailJob extends NavigationMixin(LightningElement) {
    ...
    @wire(getPicklistValues,
        {
            recordTypeId: '012800000003WkFAAU',
            fieldApiName: EmailTemplate_FIELD
        }
    )
    emailTemplateValues;
    ...
    async saveNewEmailJob(){
        ...
        const inputFields = this.template.querySelectorAll('lightning-input');
            ...
            if(allValid1 && all_Compobox_Valid){
                ...
                saveNewEmailJob({ newJob: jobRecordInfo }).then(accountId => {
                    this.dispatchEvent(
                        new ShowToastEvent({
                            title: 'Success',
